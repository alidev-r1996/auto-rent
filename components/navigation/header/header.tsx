...
const Header = () => {
  return (
    <nav
      className={`shadow-xs border-b border-b-slate-200 !bg-white/95 backdrop-blur-sm" max-w-[1690px] mx-auto md:rounded-xl  sticky top-0 p-4 flex items-center justify-between`}
    >
      <MobileHeader />
